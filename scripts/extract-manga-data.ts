...
const INPUT_FILE = "src/data/one-piece-volumes.html"
const OUTPUT_VOLUMES_FILE = "src/data/one-piece-volumes.json"
const OUTPUT_CHAPTERS_FILE = "src/data/one-piece-chapters.json"
