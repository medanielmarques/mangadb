...
const arcData = [
  ...
  },
  {
    id: "2",
    title: "Alabasta Saga",
    description: "The Straw Hat Pirates journey to Alabasta to help Princess Vivi.",
    chapters: [
      { id: "101", number: 101, title: "Reverse Mountain", rating: 8.9 },
      { id: "102", number: 102, title: "Now, the Adventure Begins", rating: 8.8 },
      { id: "103", number: 103, title: "Mr. 9 and Miss Wednesday", rating: 8.7 },
      // More chapters...
    ],
  },
  {
    ...
    description: "The Straw Hat Pirates journey to a mysterious island in the sky.",
    chapters: [
...
export function ArcList({ mangaId }: { mangaId: string }) {
  return (
    <div className="space-y-6">
      {arcData.map((arc) => (
        <div key={arc.id} className="border rounded-lg overflow-hidden">
          <div className="p-4 bg-muted/50">
            <h3 className="font-semibold text-lg">{arc.title}</h3>
